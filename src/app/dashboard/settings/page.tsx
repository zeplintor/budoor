              ...
              <div className="space-y-3">
                ...
                <div className="space-y-3">
                  {notificationOptions.map((option, index) => (
                    <label
                      key={option.value}
                      className={`group flex items-center gap-4 rounded-[var(--radius-xl)] border-2 p-4 cursor-pointer transition-all duration-300 ${notificationFrequency === option.value
